...
struct FileDescriptor {
  ...
  uint64_t meta_file_size; // Meta file size in bytes
  SequenceNumber smallest_seqno;  // The smallest seqno in this file
  SequenceNumber largest_seqno;   // The largest seqno in this file

  FileDescriptor() : FileDescriptor(0, 0, 0, 0) {}

  FileDescriptor(uint64_t number, uint32_t path_id, uint64_t _file_size, uint64_t _meta_file_size = 0)
      : FileDescriptor(number, path_id, _file_size, kMaxSequenceNumber, 0, _meta_file_size) {}

  FileDescriptor(uint64_t number, uint32_t path_id, uint64_t _file_size,
                 SequenceNumber _smallest_seqno, SequenceNumber _largest_seqno, uint64_t _meta_file_size = 0)
